...
Обратил внимание, что докер контейнеры, благодяря правильной настройке, также скидывают свои метрики в базу, так можно наблюдать общую загрузку процессора у каждого контейнера:
...
Отобразится графическая информация сгенерированная с помощью mosquitto информация, но средствами Grafana, вид представления можно поменять на спидометр и таблицу:
...
Настроим для msqtt-out тему и QoS:

<img src=pics/16.png>

Добавив элемент msqtt-in, настроим его параметры:
